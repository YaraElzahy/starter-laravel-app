...
<html lang="en">
    <head>
        ...
        <script src="{{URL::asset('https://use.fontawesome.com/releases/v5.15.4/js/all.js')}}" crossorigin="anonymous"></script>
        <!-- Google fonts-->
...
@yield('content')
    ...
    @include('includes.footer')
        ...
        <!-- Bootstrap core JS-->
        <script src="{{URL::asset('https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js')}}"></script>
        <!-- Core theme JS-->
